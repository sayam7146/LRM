...
const Home = ({ navigation }) => {
    ...
    const addreport = async () => {
        ...
        if (flag == true) {
            ...
            console.log(body);
            const response = await fetch('http:/192.168.0.110/LRM/api/user/addsugar', {
                method: 'POST',
                headers: {
            ...
            <View style={styles.container}>
                ...
                <View style={styles.bottomsubcontainer}>
                    <ScrollView
                        ...
                        <TouchableOpacity style={[{ backgroundColor: '#68F8DE', marginBottom: 20 }]} onPress={() => alert(date)}>
                            <Text style={[styles.textmenu, { marginLeft: 150 }]}>Sugar</Text>
                            ...
                            <View style={[styles.inputfields, {
                                ...
                                marginLeft: 0,
                                marginTop: 5,
                                margin: 2, width: "100%", height: "45%"
                            }]} >
                                <Text style={[{ backgroundColor: '#68F8DE', fontSize: 20, fontFamily: 'Poppins-Medium', marginLeft: 15, width: "35%" }]}>
                                    Value</Text>
                                <Text style={[{ fontSize: 20, fontFamily: 'Poppins-Medium', width: "30%", paddingRight: 50, marginRight: 10 }]}>
                                    Date</Text>
                        ...
                        {list.map((item) => {
                            ...
                            return (
                                <View
                                    ...
                                    <TextInput keyboardType='numeric' placeholder='Value' style={[{ padding: 3, backgroundColor: "white", fontSize: 18, width: "23%", height: "100%" }]}
                                        onChangeText={newText => updatetext(newText, item)
                                        }
                                    ></TextInput>
                                    ...
                                    <TouchableOpacity onPress={() => showmode('date', item)} style={[{ marginLeft: 0, marginRight: 10, borderTopLeftRadius: 40, borderBottomRightRadius: 40, flexDirection: 'row', }]} >
