...
const Home = ({ navigation }) => {
    ...
    const showreport=(index)=>{
        ...
        navigation.navigate("userlabreportdata");
    }
                    ...
                    <ScrollView
                        ...
                        <TouchableOpacity style={[{ backgroundColor: '#68F8DE', marginBottom: 20 }]} >
                            ...
                            marginLeft: 15,
                                ...
                                <Text style={[{ backgroundColor: '#68F8DE', fontSize: 20, fontFamily: 'Poppins-Medium', marginRight:100 }]}>
                                    {global.username} Lab Reports</Text>
                                </View>
                        ...
                        {countlist.map((item)=>{return(
                                <View key={item}><TouchableOpacity onPress={()=>showreport(item)} >
                                    ...
                                    <Text style={{fontWeight:'bold', fontSize: 22, fontFamily: 'Poppins-Medium',width:"65%"}}>{testnames[item]}</Text>
