...
function Signup({ navigation }) {
    ...
    const checksignup = async () => {
        if (usertext == "" || passwordtext == "" || passwordchtext == "" || agetext == "")
            ...
            const response = await fetch('http://192.168.0.110/LRM/api/user/insertuser', {
                method: 'POST',
                headers: {
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <View style={styles.topsubcontainerimg}>
                ...
                <Text style={[styles.welcometext, { fontFamily: 'Poppins-SemiBold', marginTop: 10, marginLeft: 80 }]}>User Signup</Text>
            </View>
